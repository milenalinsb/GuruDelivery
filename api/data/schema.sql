...
CREATE TABLE IF NOT EXISTS pedido (
    ...
    CONSTRAINT pedido_id_endereco FOREIGN KEY (endereco_id) REFERENCES endereco(id)
);
...
ALTER TABLE carrinho ADD CONSTRAINT pk_carrinho PRIMARY KEY (id);
ALTER TABLE carrinho ADD CONSTRAINT fk_carrinho_usuario FOREIGN KEY (usuario_id) REFERENCES usuario;
ALTER TABLE carrinho ADD CONSTRAINT fk_carrinho_produto FOREIGN KEY (produto_id) REFERENCES produto;
ALTER TABLE carrinho ADD CONSTRAINT fk_carrinho_empresa FOREIGN KEY (empresa_id) REFERENCES empresa;
